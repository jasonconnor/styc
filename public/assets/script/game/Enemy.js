class Enemy {
    constructor(playerLevel) {
        ...
        this.maxPossibleHealth = enemyStartingMaxHealth + 2.5 * (this.level - 1);
        this.maxHealth = Math.ceil(Math.random() * this.maxPossibleHealth);
        this.health = this.maxHealth;
        this.attack = enemyStartingMaxAttack + 1.3 * this.level * (this.level - 1);
    ...
    power() {
        return Math.ceil(Math.random() * this.attack);
    }
